...
### 1. Install dependencies using python system environment
...
### 4. Test checkm2 and gtdbtk command in MetaCAT
...
### 5. Install dependencies using Conda/Mamba

### 2. Download database from [Zenodo](https://zenodo.org/records/14897628)
...
### 3. Download database from [GTDB-Tk](https://ecogenomics.github.io/GTDBTk/installing/index.html#installing-gtdbtk-reference-data)
