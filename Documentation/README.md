...
```text
usage: MetaCAT abundance [options] -a <ANNOTATION> -b <BAMs> -o <ABUNDANCE>
...
The mapping between each sequence ID and cluster ID generated by the `cluster` command in `MetaCAT`.
