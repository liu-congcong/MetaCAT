...
def __init__():
    ...
    seed_parser.add_argument(
        '--fraggenescan', default = 'FragGeneScan', type = str, required = False, metavar = '<str>',
        help = 'Path to the "FragGeneScan".\nDefault: environmental FragGeneScan.'
    )
    seed_parser.add_argument(
        '--hmmsearch', default = 'hmmsearch', type = str, required = False, metavar = '<str>',
        help = 'Path to the "hmmsearch".\nDefault: environmental hmmsearch.'
    )
    seed_parser.add_argument(
        '--hmmpress', default = 'hmmpress', type = str, required = False, metavar = '<str>',
    ...
    representative_parser.add_argument(
        '--mash', default = 'mash', type = str, required = False, metavar = '<str>',
